...
adapted for Contour's dark-first professional icon authoring workspace.
...
- **Display font:** Geist Sans at weight 450 (default) — the Contour equivalent of
...
### Principles
- **Restrained weight as identity**: Like ElevenLabs' Waldenburg 300, Contour uses weight
...
> Build this as a dark, professional authoring tool UI for Contour Studio using existing
