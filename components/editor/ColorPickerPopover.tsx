    ...
    <div className={cn('flex items-center gap-1.5', className)}>
      <Popover>
        <PopoverTrigger asChild disabled={disabled}>
          <button
            type="button"
            className={cn(
              'h-7 w-7 shrink-0 rounded-md border border-input shadow-sm transition-colors hover:border-ring focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring',
      ...
      <div className="relative flex h-7 min-w-0 flex-1 items-center">
        ...
        <input
          ...
          disabled={disabled}
          className="h-7 w-full min-w-0 rounded-md border border-input bg-transparent pl-4 pr-1.5 font-mono text-[11px] leading-7 text-foreground shadow-sm outline-none transition-colors focus:border-ring disabled:opacity-50"
          spellCheck={false}
          autoComplete="off"
        />
      </div>
      ...
      {onOpacityChange != null && (
        <div className="relative flex h-7 w-12 shrink-0 items-center">
          <input
            ...
            disabled={disabled}
            className="h-7 w-full rounded-md border border-input bg-transparent pl-1.5 pr-5 text-center font-mono text-[11px] leading-7 text-foreground shadow-sm outline-none transition-colors focus:border-ring disabled:opacity-50"
          />
