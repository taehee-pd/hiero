 ...
 *
 * Displays the cuneiform dev server connection status and lets the editor
 ...
 * The consumer must run `cuneiform dev` in their repo for this to work.
 *
      ...
      <div className="rounded-lg border border-border/70 bg-background/70 p-3">
        ...
        {connectionStatus === 'disconnected' && (
          <p className="mt-2 text-[10px] text-amber-600">
            ...
            <code className="font-mono">cuneiform dev</code> in the consumer repo.
          </p>
        )}
      </div>
