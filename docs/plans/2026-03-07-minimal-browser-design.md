...
Icophone already has both an explorer and an editor. The current redesign direction is to stop treating the explorer like a landing page and instead make both screens feel like one quiet tool.
