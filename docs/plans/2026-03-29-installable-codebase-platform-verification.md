...
This verification checks whether the reviewed installable Hiero plan is consistent with the repository's canonical architecture, the new repo-native product boundary, the rewritten spec-kit documents, and the current code surfaces that will need implementation work.
...
- [docs_canonical/ARCHITECTURE.md](/Users/taehee/Hiero/docs_canonical/ARCHITECTURE.md)
- [scripts/compile-from-source.ts](/Users/taehee/Hiero/scripts/compile-from-source.ts)
- [scripts/validate-source-export.ts](/Users/taehee/Hiero/scripts/validate-source-export.ts)
...
- [lib/export/export-runtime-json.ts](/Users/taehee/Hiero/lib/export/export-runtime-json.ts)
- [lib/export/adapters/react-adapter.ts](/Users/taehee/Hiero/lib/export/adapters/react-adapter.ts)
- [lib/export/export-react/generate-component.ts](/Users/taehee/Hiero/lib/export/export-react/generate-component.ts)
...
- [lib/export/adapters/storybook-generator.ts](/Users/taehee/Hiero/lib/export/adapters/storybook-generator.ts)
- [tests/storybook-generator.test.ts](/Users/taehee/Hiero/tests/storybook-generator.test.ts)
...
- The reviewed direction centers repo-root `hiero.config.ts` and removes `project.syncTargets` rather than migrating it.
...
- [lib/schema/types.ts](/Users/taehee/Hiero/lib/schema/types.ts#L16)
- [lib/editor-store/store.ts](/Users/taehee/Hiero/lib/editor-store/store.ts)
- [lib/runtime-core/transition-resolver.ts](/Users/taehee/Hiero/lib/runtime-core/transition-resolver.ts)
- [lib/export/export-runtime-json.ts](/Users/taehee/Hiero/lib/export/export-runtime-json.ts)
...
- The v1 contract is Figma ingress, Hiero SSOT in repo, repo-root config, and direct React codebase publish.
...
- Which generated files are owned by Hiero in direct React publish mode, and how is stale-output cleanup enforced?
...
2. remove `project.syncTargets` and move install behavior to `hiero.config.ts`
