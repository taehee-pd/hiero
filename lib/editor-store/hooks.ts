...
const editorActions = {
  ...
  addLayer: editorStore.getState().addLayer,
  ...
  duplicateSelectedLayers: editorStore.getState().duplicateSelectedLayers,
  copySelectedLayers: editorStore.getState().copySelectedLayers,
  pasteLayers: editorStore.getState().pasteLayers,
  reorderSelectedLayers: editorStore.getState().reorderSelectedLayers,
  moveLayerToIndex: editorStore.getState().moveLayerToIndex,
