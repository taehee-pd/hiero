# Cuneiform -- Specification Index

This directory contains structured specifications for the Cuneiform's core systems. Each spec documents types, function signatures, behavior rules, and edge cases derived from the implementation source.
...
| [install-config.md](./schema/install-config.md) | `cuneiform.config.ts` contract: `sourceDir`, live `hostTargets`, and release `releaseTargets` |
...
| [repo-native-workflow.md](./ui/repo-native-workflow.md) | Figma ingress, Cuneiform SSOT, repo-aware editing, direct React publish, and optional Figma back-sync |
...
| [repo-native-distribution.md](./export/repo-native-distribution.md) | Live integration lane vs release distribution lane for repo-native installable Cuneiform workflows |
