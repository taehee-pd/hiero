...
| [install-config.md](./schema/install-config.md) | `coniva.config.ts` contract: `sourceDir`, live `hostTargets`, and release `releaseTargets` |
...
| [repo-native-workflow.md](./ui/repo-native-workflow.md) | Figma ingress, Coniva SSOT, repo-aware editing, direct React publish, and optional Figma back-sync |
...
| [repo-native-distribution.md](./export/repo-native-distribution.md) | Live integration lane vs release distribution lane for repo-native installable Coniva workflows |
