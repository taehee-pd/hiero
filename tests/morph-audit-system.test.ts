...
const PAIRS: PairCase[] = [
  ...
  { id: 'heart-heart-fill', from: [makeLayer('glyph', 'M12 21 C10 19 4 15 4 9 C4 6 6 4 9 4 C10.8 4 12 5.2 12 6.5 C12 5.2 13.2 4 15 4 C18 4 20 6 20 9 C20 15 14 19 12 21', 'primary')], to: [makeLayer('glyph', 'M12 21 C10 19 4 15 4 9 C4 6 6 4 9 4 C10.8 4 12 5.2 12 6.5 C12 5.2 13.2 4 15 4 C18 4 20 6 20 9 C20 15 14 19 12 21 Z', 'primary')], expected: 'fallback' },
  { id: 'bell-bell-fill', from: [makeLayer('glyph', 'M12 3 C9 3 7 5 7 8 V13 L5 16 H19 L17 13 V8 C17 5 15 3 12 3', 'primary')], to: [makeLayer('glyph', 'M12 3 C9 3 7 5 7 8 V14 L5 16 H19 L17 14 V8 C17 5 15 3 12 3 Z', 'primary')], expected: 'fallback' },
