...
describe('detectSchemaVersion', () => {
  test('extracts $schema from a valid object', () => {
    const version = detectSchemaVersion({
      $schema: 'https://icophone.dev/schemas/compiled-icon/0.9.0',
    });
    expect(version).toBe('https://icophone.dev/schemas/compiled-icon/0.9.0');
  });
...
describe('single-step migration', () => {
  const V090 = 'https://icophone.dev/schemas/compiled-icon/0.9.0';
...
describe('multi-step chain migration', () => {
  const V080 = 'https://icophone.dev/schemas/compiled-icon/0.8.0';
  const V090 = 'https://icophone.dev/schemas/compiled-icon/0.9.0';
  ...
  test('chain returns null when no migration path exists', () => {
    const registry = createMigrationRegistry();
    const migrate = registry.chain('https://icophone.dev/schemas/compiled-icon/0.1.0');
...
describe('unknown schema version error handling', () => {
  test('createMigrationHook throws for unknown schema version', () => {
    ...
    const unknownUri = 'https://icophone.dev/schemas/compiled-icon/0.5.0';
...
describe('createMigrationHook integration', () => {
  ...
  test('hook throws when registry has no path for the encountered schema', () => {
    ...
    payload.$schema = 'https://icophone.dev/schemas/compiled-icon/0.1.0';
